...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, 	"/", "/index", "/login", "/register", "/css/**", "/images/**", "/operazioniMovies", "/operazioniArtists", "/operazioniNews",
										"/movies", "/movie/**", "/artists", "/artist/**", "/allNews", "/news/**" ).permitAll()
